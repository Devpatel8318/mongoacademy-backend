import { Collection, Document, isEqual, Router } from 'deps'
...
// 	]),
// 	(ctx) => {
// 		pushMessageInSqs(config.aws.sqs.mongoAcademyRestToQueryProcessorQueue, {
// 			hello: 'world',
// 		}, {
...
router.post('/test2', (ctx) => {
	pushMessageInSqs(
		config.aws.sqs.mongoAcademyRestToQueryProcessorQueue,
		{
			question: {
